<template>
  <div class="app-container batCreateOrder">
    ...
    <el-table class="mb8" :height="screen_height-350" v-loading="loading" :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="客户名称" prop="purchaser_name" width="260"/>
      <el-table-column align="center" label="税率" prop="tax_name" width="80" />
      <el-table-column align="center" label="结算方式" prop="" width="80" />
      <el-table-column align="center" label="付款状态" prop="" width="100" />
      <el-table-column align="center" label="交货日期" prop="" width="100" />
      <el-table-column align="center" label="客户订单号" prop="" width="180" />

<template>
  <div class="app-container reReturnRecords">
    <el-form class="mb10" :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
      ...
      <el-form-item>
        <el-select v-model="queryParams.invoiceStatus" size="small" style="width: 100px">
          ...
          <el-option label="未转备货" value="notVoice"></el-option>
          <el-option label="已转备货" value="invoiced"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="12">
        ...
        <span class="f14 table_tip">点击“退货单号”可以进入退货单页，点击“订单号”可以进入订单页。</span>
      </el-col>
    </el-row>
    ...
    <el-table class="mb8" height="490" v-loading="loading" :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable align="center" label="供应商名称" prop="purchase_name"/>
      <el-table-column sortable align="center" label="销售人" prop="saler" width="100" />
      <el-table-column sortable align="center" label="收货人" prop="receiver" width="100" />
      <el-table-column sortable align="center" label="收货时间" width="160"></el-table-column>

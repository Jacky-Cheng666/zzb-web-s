<template>
  <div class="app-container alreadyAskPrice">
    ...
    <el-table class="mb8" :height="screen_height-350" v-loading="loading" :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="A级报价" prop="" width="120" />
      <el-table-column align="center" label="B级报价" prop="" width="120" />
      <el-table-column align="center" label="C级报价" prop="" width="120" />

  ...
  data() {
    return {
      ...
      saleManage:[
          ...
          {title: '预备订单', url:'/saleManage/preOrder'},
          {title: '协同报价', url:'/saleManage/synergyOfferPrice'},
          {title: '客户询价', url:'/saleManage/customerAskPrice/overView'},
          ...
          {title: '对账中心', url:'/saleManage/billCenter'},
      ...
      companyManage: [
        {title: '审批中心', url:''},
        {title: '组织架构', url:'/enterpriseManage/addressBook'},
